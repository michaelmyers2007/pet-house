 ...
 <div class="outer-w3-agile mt-3">
                    ...
                    <form action="{{ route('accessory.update',$accessory->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="tab-content" id="myTabContent">
                         <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"><img src="{{asset($accessory->photo)}}" class="img-fluid w-25"><input type="hidden" name="oldimage" value="{{$accessory->photo}}"></div>
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab"> <input type="file" name="photo" value="" class="form form-control {{$errors->has('photo') ? 'is-invalid' : ''}}">
                         ...
                         <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="price" value="{{$accessory->price}}" required="">
                        </div>
                         <div class="form-group">
                            <label for="inputAddress">No of accessory</label>
                            <input type="text" class="form-control" name="code" value="{{$accessory->no_accessories}}" required="">
                        </div>
